...
class Line(object):
    ...
    def radius_of_curvature(self):
        ...
        xm_per_pix = 1.7 / 700  # meters per pixel in x dimension
        # Fit new polynomials to x,y in world space
        points = self.get_points()
        y = points[:, 1]
        x = points[:, 0]
        # print y, ym_per_pix, x, xm_per_pix
    ...
    def camera_distance(self):
        ...
        """
        points = self.get_points()
        xm_per_pix = 2.7 / 700  # meters per pixel in x dimension
        print points
